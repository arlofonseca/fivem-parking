...
AddEventHandler("playerSpawned", function()
    ...
    if settings then
        ...
        lib.print.info(("Impound price: %s \n Cached Data: %s"):format(Impound and Impound.price or "nil", settings))
    end
end)
...
RegisterNuiCallback("bgarage:nui:getLocation", function(data, cb)
    ...
    data.location == "outside" and lib.callback.await("bgarage:server:getVehicleCoords", false, data.plate)?.xy or nil
