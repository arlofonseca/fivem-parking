...
const VehicleContainer: React.FC<Props> = React.memo(
  ({ className, vehicles, inImpound }) => {
    return (
      <>
                  ...
                  >
                    ...
                    <Menu.Dropdown>
                      {vehicle.location !== "outside" && (
                        <Menu.Item
                          disabled={
                            vehicle.location === "impound" && !inImpound
                          }
                        >
                          <button
                          ...
                          >
                            <KeySquare size={16} strokeWidth={2.5} /> Get
                            Vehicle
                          </button>
                        </Menu.Item>
                      )}
                      ...
                      <Menu.Item>
                        ...
                        >
                          <MapPinned size={16} strokeWidth={2.5} /> Locate
                          Vehicle
                        </button>
                      </Menu.Item>
                    </Menu.Dropdown>
