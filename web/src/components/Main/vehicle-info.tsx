      ...
      >
        <div className="flex flex-col gap-2">
          <p className="flex gap-1 items-center ml-1">
            ...
            <span className="font-inter text-sm truncate font-semibold">
          ...
          <div className="flex gap-1 items-center">
            <TextBlock
              Icon={MapPinned}
              className="text-[10px] !p-[3px] capitalize"
              size={14}
            >
            ...
            <TextBlock
              Icon={
                vehicleData.location === "impound"
                  ? ParkingSquareOff
                  : ParkingSquare
              }
              iconClassName={`${
                vehicleData.location !== "parked" && "text-red"
              }`}
